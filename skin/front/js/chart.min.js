...
class DatasetController {
  ...
  applyStack(t, e, i) {
    var a = this.chart,
      ...
      n = e[t.axis];
    return applyStack(
      { keys: getSortedDatasetIndices(a, !0), values: e._stacks[t.axis] },
      n,
      s.index,
      { mode: i }
    );
  ...
  _resolveElementOptions(t, e = "default", i) {
    ...
    if (n) return cloneIfNotShared(n, r);
    const o = this.chart.config;
    var n = o.datasetElementScopeKeys(this._type, t),
      l = a ? [t + "Hover", "hover", t, ""] : [t, ""],
      n = o.getOptionScopes(this.getDataset(), n),
      t = Object.keys(defaults.elements[t]);
    const h = o.resolveNamedOptions(n, t, () => this.getContext(i, a), l);
    return (
      h.$shared &&
        ((h.$shared = r), (s[e] = Object.freeze(cloneIfNotShared(h, r)))),
      h
    );
  }
...
class BarController extends DatasetController {
  ...
  _calculateBarValuePixels(t) {
    ...
    let h = r[e.axis],
      c = 0,
      d = i ? this.applyStack(e, r, i) : h,
      u,
      g;
    d !== h && ((c = d - h), (d = h)),
      l &&
        ((h = o.barStart),
        (d = o.barEnd - o.barStart),
        0 !== h && sign(h) !== sign(o.barEnd) && (c = 0),
        (c += h));
    var r = isNullOrUndef(a) || l ? c : a;
    let p = e.getPixelForValue(r);
    return (
      (u = this.chart.getDataVisibility(t) ? e.getPixelForValue(c + d) : p),
      (g = u - p),
      Math.abs(g) < s &&
        ((g = barSign(g, e, n) * s),
        h === n && (p -= g / 2),
        (o = e.getPixelForDecimal(0)),
        (l = e.getPixelForDecimal(1)),
        (r = Math.min(o, l)),
        (t = Math.max(o, l)),
        (p = Math.max(Math.min(p, t), r)),
        (u = p + g)),
      p === e.getPixelForValue(n) &&
        ((o = (sign(g) * e.getLineWidthForValue(n)) / 2), (p += o), (g -= o)),
      { size: g, base: p, head: u, center: u + g / 2 }
    );
  }
        ...
        if (isArray(d))
          for (h = 0, c = d.length; h < c; ++h)
            (x = d[h]),
              isNullOrUndef(x) ||
                isArray(x) ||
                ((m = _measureText(i, p.data, p.gc, m, x)), (v += f));
          ...
          (D =
            "top" === a
              ? "near" === h || 0 != g
                ? -M * S + S / 2
                : "center" === h
                ? -C.highest.height / 2 - A * S + S
                : -C.highest.height + S / 2
              : "near" === h || 0 != g
              ? S / 2
              : "center" === h
              ? C.highest.height / 2 - A * S
              : C.highest.height - M * S),
          d && (D *= -1),
          0 == g || w.showLabelBackdrop || (x += (S / 2) * Math.sin(g)))
        : ((b = y), (D = ((1 - M) * S) / 2));
      let i;
      if (w.showLabelBackdrop) {
        var A = toPadding(w.backdropPadding),
          E = C.heights[f],
          I = C.widths[f];
        let t = D - A.top,
          e = 0 - A.left;
...
function createDoughnutDatasetColorizer() {
  let e = 0;
  return (t) => {
    t.backgroundColor = t.data.map(() => getBorderColor(e++));
  };
}
function createPolarAreaDatasetColorizer() {
  let e = 0;
  return (t) => {
    t.backgroundColor = t.data.map(() => getBackgroundColor(e++));
  };
}
function getColorizer(t) {
  return (
    "doughnut" === t || "pie" === t
      ? createDoughnutDatasetColorizer
      : "polarArea" === t
      ? createPolarAreaDatasetColorizer
      : createDefaultDatasetColorizer
  )();
}
...
var plugin_colors = {
  ...
  beforeLayout(t, e, i) {
    if (i.enabled) {
      ...
      containsColorsDefinitions(n) ||
        (s && containsColorsDefinitions(s)) ||
        ((i = getColorizer(a)), n.forEach(i));
    }
  },
};
...
class Legend extends Element {
  ...
  _draw() {
    ...
    this.drawTitle(),
      ...
      (f.lineWidth = 0.5),
      (f.font = _.string);
    const { boxWidth: D, boxHeight: P, itemHeight: C } = getBoxSize(v, k),
      w = this.isHorizontal(),
        ...
        isNaN(D) ||
          ...
          v.usePointStyle
            ...
            : ((o = h + Math.max((k - P) / 2, 0)),
              ...
              0 !== r && f.stroke()),
          f.restore()),
        (s = _textX(a, s + D + S, w ? s + i : this.right, u.rtl)),
        (h = b.x(s)),
        (e = n),
        (c = t),
        renderText(f, c.text, h, e + C / 2, _, {
