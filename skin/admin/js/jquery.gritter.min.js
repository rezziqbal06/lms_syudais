 ...
 * jQuery Growl v1.3.5
 *
 * Copyright (c) 2018 Kevin Sylvestre, http://github.com/ksylvest
...
/*!
 * bootstrap-growl v1.11.0
 *
 * Copyright (c) 2018 Nick Larson, http://github.com/ifightcrime
 * Released under the MIT license
 *
...
(function () {
  ...
  c.bootstrapGrowl = function (f, a) {
    ...
    b = c("<div>");
    b.attr("class", "bootstrap-growl alert fade show");
    b.attr("role", "alert");
    a.type && b.addClass("alert-" + a.type);
    a.allow_dismiss && (b.addClass("alert-dismissible"), b.append('<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>'));
    b.append(f);
