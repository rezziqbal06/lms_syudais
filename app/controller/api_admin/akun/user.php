...
class User extends JI_Controller
{
	...
	public function edit($id)
	{
		...
		$this->bum->columns['kelamin']->value = $this->__($bum, 'kelamin', '1');
		...
		$this->bum->columns['api_web_date']->value = $this->__($bum, 'api_web_date', 'NOW()');
		$this->bum->columns['api_mobile_date']->value = $this->__($bum, 'api_mobile_date', 'NOW()');
