<div id="page-content">
    ...
    <div class="content-header">
        <div class="row">
            <div class="col-md-12">
                <div class="btn-group">
                    <a id="aback" href="<?= base_url_front('user/') ?>" class="btn btn-default"><i class="fa fa-chevron-left"></i> Kembali </a>
                </div>
            </div>
        </div>
    </div>
    <ul class="breadcrumb breadcrumb-top">
        <li>Akun</li>
        <li><a href="<?= base_url_front("user/") ?>">Kustomer</a></li>
        <li>Baru</li>
    </ul>
    ...
    <div class="block full row">
        ...
        <form id="ftambah" action="<?= base_url_front() ?>" method="post" enctype="multipart/form-data" class="form-bordered form-horizontal" onsubmit="return false;">
            <input type="hidden" name="a_company_id" value="<?=isset($this->current_reseller->id) ? $this->current_reseller->id : 'null'?>" />
            <input type="hidden" name="kelamin" value="null" />
            <input type="hidden" name="bdate" value="null" />
