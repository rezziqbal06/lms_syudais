...
/**
 * Define all general method(s) and constant(s) for b_indikator_pencapaian table,
 ...
 * @since 1.0.0
 */
class B_Indikator_Pencapaian_Concern extends \JI_Model
{
    public $tbl = 'b_indikator_pencapaian';
    public $tbl_as = 'bip';
