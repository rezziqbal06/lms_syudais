<?php
class Dump extends JI_Controller
{
    private $module_name = 'Dump';
    ...
    public function index()
    {
        ...
        $this->cli->print_command_item('dump', 'schema', 'Generates schema.json');
        $this->cli->print_command_item('dump', 'sql', 'Dump database into  sql/[DB_NAME].sql');
    }
