<?php
/**
* Builder Class for building email
*
*
* Cara penggunaan
* ====================================
...
class Seme_Email
{
    ...
    {
        if (!defined('SEMEDIR') && !defined('SEMECFG')) {
            $root = str_replace("\\", "/", realpath("").'/');
            $this->directories = new stdClass();
            $this->directories->kero_lib = $root.DS.'kero/lib/';
        } else {
    ...
    /**
     * Flush the value of props that has been set
     *
     * @return Seme_Email Current Seme_Email object
     */
     ...
     * @param  string $name               name of email address
     *
     * @return Seme_Email Current Seme_Email object
     */
    ...
    /**
     * Set `Reply-To` value, can be called multiple times
     *
     * @param  string $mail               Email Address
     * @param  string $name               name of email address
     *
    ...
    /**
     * Set `To` value, can be called multiple times
     *
     * @param  string $mail               Email Address
     * @param  string $name               name of email address
     *
    ...
    /**
     * Set `CC` value, can be called multiple times
     *
     * @param  string $mail               Email Address
     *
     * @return Seme_Email Current Seme_Email object
    ...
    /**
     * Set `BCC` value, can be called multiple times
     *
     * @param  string $mail               Email Address
     *
     * @return Seme_Email Current Seme_Email object
    ...
    /**
     * Set email subject strings
     *
     * @param  string $subject               Text Subject of the email
     *
     * @return Seme_Email Current Seme_Email object
     */
    ...
    /**
     * Set email content text (ASCII format)
     *
     * @param  string $subject               Text Subject of the email
     *
     * @return Seme_Email Current Seme_Email object
    ...
    /**
     * Set email content text (HTML format)
     *
     * @param  string $subject               Text Subject of the email
     * @param  string $type                  Encoding type, default: windows
     *
     * @return Seme_Email Current Seme_Email object
     */
    ...
    public function template($template)
    {
        ...
        $basetemp = $this->directories->kero_lib.'seme_email/';
        if (!is_dir($basetemp)) {
            mkdir($basetemp);
        }
        $basetemp = $this->directories->kero_lib.'seme_email/template/';
        if (!is_dir($basetemp)) {
            mkdir($basetemp);
        }
     ...
     * Add an attachment
     *
     * @param string $filepath  Full qualified path
     * @param string $filename  Set the filename on email attachment, optional.
     *
     * @return Seme_Email Current Seme_Email object
     */
    ...
    /**
     * Trigger the `send_email` command
     *
     * @return Seme_Email Current Seme_Email object
     */
     ...
     * Get the log
     *
     * @return string Full logged email text
     */
