...
/**
* get sales scoped base url
*
* @param  string $url addtional url
*
* @return string      full url
*/
function base_url_sales($url='')
{
    return  $GLOBALS['SEMECFG']->baseurl.$GLOBALS['SEMECFG']->baseurl_sales.'/'.$url;
}

/**
* get reseller scoped base url
*
* @param  string $url addtional url
*
* @return string      full url
*/
function base_url_reseller($url='')
{
    return  $GLOBALS['SEMECFG']->baseurl.$GLOBALS['SEMECFG']->baseurl_reseller.'/'.$url;
}
